    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="{{route('dashboard')}}">
                ...
                <img src="{{asset('/')}}admin/assets/images/brand/Error_Hero_Icon.png" class="header-brand-img light-logo1"
                     alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-md-flex shopping-cart">
                                <a href="javascript:void(0);" class="nav-link icon text-center" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <span class="badge bg-info header-badge">{{ $total_unRead_contacts }}</span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex">
                                            <h6 class="mt-1 mb-0 fs-15 text-dark">Contact Messages</h6>
                                        </div>
                                    </div>
                                    <div class="message-menu ps2 overflow-hidden">
                                        @foreach($contacts->sortByDesc('created_at')->take(6) as $contact)
                                            @if($contact->status == 'unRead')
                                                <a class="dropdown-item d-flex" href="{{route('contact-us.show', $contact->id)}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" class="text-success px-1" enable-background="new 0 0 24 24" viewBox="0 0 512 512"><path d="M168.2 384.9c-15-5.4-31.7-3.1-44.6 6.4c-8.2 6-22.3 14.8-39.4 22.7c5.6-14.7 9.9-31.3 11.3-49.4c1-12.9-3.3-25.7-11.8-35.5C60.4 302.8 48 272 48 240c0-79.5 83.3-160 208-160s208 80.5 208 160s-83.3 160-208 160c-31.6 0-61.3-5.5-87.8-15.1zM26.3 423.8c-1.6 2.7-3.3 5.4-5.1 8.1l-.3 .5c-1.6 2.3-3.2 4.6-4.8 6.9c-3.5 4.7-7.3 9.3-11.3 13.5c-4.6 4.6-5.9 11.4-3.4 17.4c2.5 6 8.3 9.9 14.8 9.9c5.1 0 10.2-.3 15.3-.8l.7-.1c4.4-.5 8.8-1.1 13.2-1.9c.8-.1 1.6-.3 2.4-.5c17.8-3.5 34.9-9.5 50.1-16.1c22.9-10 42.4-21.9 54.3-30.6c31.8 11.5 67 17.9 104.1 17.9c141.4 0 256-93.1 256-208S397.4 32 256 32S0 125.1 0 240c0 45.1 17.7 86.8 47.7 120.9c-1.9 24.5-11.4 46.3-21.4 62.9zM144 272a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm144-32a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm80 32a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg>
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                                            <h5 class="mb-1">{{$contact->name}}</h5>
                                                            <small class="text-muted ms-auto text-end"> {{ $contact->created_at->setTimezone('Asia/Dhaka')->format('M d, Y, h:ia') }} </small>
                                                        </div>
                                    ...
                                    <div class="text-center p-3">
                                        <a class="btn btn-primary" href="{{route('contact-us.index')}}" >View All Messages</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dropdown d-md-flex shopping-cart">
                                <a href="javascript:void(0);" class="nav-link icon text-center" data-bs-toggle="dropdown" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 22 22" viewBox="0 0 448 512">
                                        <path d="M224 0c-17.7 0-32 14.3-32 32V51.2C119 66 64 130.6 64 208v25.4c0 45.4-15.5 89.5-43.8 124.9L5.3 377c-5.8 7.2-6.9 17.1-2.9 25.4S14.8 416 24 416H424c9.2 0 17.6-5.3 21.6-13.6s2.9-18.2-2.9-25.4l-14.9-18.6C399.5 322.9 384 278.8 384 233.4V208c0-77.4-55-142-128-156.8V32c0-17.7-14.3-32-32-32zm0 96c61.9 0 112 50.1 112 112v25.4c0 47.9 13.9 94.6 39.7 134.6H72.3C98.1 328 112 281.3 112 233.4V208c0-61.9 50.1-112 112-112zm64 352H224 160c0 17 6.7 33.3 18.7 45.3s28.3 18.7 45.3 18.7s33.3-6.7 45.3-18.7s18.7-28.3 18.7-45.3z"/>
                                    </svg>
                                    <span class="badge bg-info header-badge">{{ $total_unRead_subscribes }}</span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none">
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex">
                                            <h6 class="mt-1 mb-0 fs-15 text-dark">Subscribes</h6>
                                        </div>
                                    </div>
                                    <div class="message-menu ps2 overflow-hidden">
                                        @foreach($subscribes->sortByDesc('created_at')->take(6) as $subscribe)
                                            @if($subscribe->status == 'unRead')
                                                <a class="dropdown-item d-flex" href="{{route('subscribe.show', Crypt::encryptString($subscribe->id) )}}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" height="24" width="24" class="text-success px-1" viewBox="0 0 512 512">
                                                    ...
                                                    <div class="wd-90p">
                                                        <div class="d-flex">
                                                            @if ($subscribe && $subscribe->user)
                                                                <h5 class="mb-1">{{$subscribe->user->name}}</h5>
                                                            @endif
                                                            <small class="text-muted ms-auto text-end"> {{ $subscribe->created_at->setTimezone('Asia/Dhaka')->format('M d, Y, h:ia') }} </small>
                                                        </div>
                                                        <span class="fs-12 text-muted">{{$subscribe->email}}</span>
                                                    </div>
                                                </a>
                                            @endif
                                        @endforeach
