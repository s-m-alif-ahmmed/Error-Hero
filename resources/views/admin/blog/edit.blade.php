                    ...
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row g-3" method="post" action="{{route('blog.update', Crypt::encryptString($blog->id) )}}" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    <label class="form-label" for="meta_author"> Blog Page Meta Author Name </label>
                                    <input class="form-control" type="text" name="meta_author" id="meta_author" placeholder="Enter blog page meta author name " value="{{ $blog->meta_author }}"  />
                                </div>

                                <div class="col-12">
                                    <label class="form-label" for="meta_description"> Blog Page Meta Description </label>
                                    <textarea class="form-control" type="text" name="meta_description" id="meta_description" placeholder="Enter blog page meta description "  >{{ $blog->meta_description }}</textarea>
                                </div>

                                <div class="col-12">
                                    <label class="form-label" for="meta_keyword"> Blog Page Meta Keywords </label>
                                    <textarea class="form-control" type="text" name="meta_keyword" id="meta_keyword" placeholder="Enter blog page meta keywords " >{{ $blog->meta_keyword }}</textarea>
                                </div>
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <select class="form-control select2 form-select" name="category_id" id="category_id" data-placeholder="Choose one category" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" name="short_description" id="short_description" placeholder="Enter short description" required >{{ $blog->short_description }}</textarea>
                                </div>

                                <div class="col-12">
                                    <label for="editor" class="form-label"> Blog Description </label>
                                    <textarea class="form-control" name="description" id="editor" placeholder="Enter description" required >{{ $blog->description }}</textarea>
                                </div>
