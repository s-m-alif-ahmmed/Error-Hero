...
Route::middleware(['log.visitor'])->group(function () {
    ...
    Route::get('/blogs/{category_slug}', [WebsiteController::class, 'blogs'])->name('blogs');
    Route::get('/blogs/tag/{tag_slug}', [WebsiteController::class, 'blogTag'])->name('blog.tag');
...
//                Activity Log
                Route::resource('/admin/activity-log',VisitorController::class);
